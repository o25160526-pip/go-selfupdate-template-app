...
check_text azure-pipelines.yml 'stage: SmokeUpdate'
check_text azure-pipelines.yml 'stage: Publish'
check_text azure-pipelines.yml 'UniversalPackages@0'
check_text azure-pipelines.yml 'views/@Release'
check_text azure-pipelines.yml 'POST-PUBLISH PASS'
check_text azure-pipelines.yml 'go run ./cmd/binarysign'
check_text azure-pipelines.yml 'buildinfo.DefaultAzureIndexURL'
